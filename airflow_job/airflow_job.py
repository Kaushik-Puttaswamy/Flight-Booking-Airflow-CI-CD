...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-project-gds")
    bq_project = Variable.get("bq_project", default_var="wide-song-442922-d2")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"airflowproject-1/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/airflowproject-1/spark-job/spark_transformation_job.py",  # Main Python file
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "272725850476-compute@developer.gserviceaccount.com",
                "network_uri": "projects/wide-song-442922-d2/global/networks/default",
                "subnetwork_uri": "projects/wide-song-442922-d2/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="wide-song-442922-d2",
        region="us-central1",
